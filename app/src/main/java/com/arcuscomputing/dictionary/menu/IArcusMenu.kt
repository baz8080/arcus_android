...
interface IArcusMenu {
    ...
    companion object {
        ...
        const val MENU_FAVOURITES = 3
        const val MENU_RANDOM = 4
        const val MENU_ALPHA_SORT = 5
        const val MENU_DATE_SORT = 6
        const val MENU_CLEAR_FAVOURITES = 7
        const val MENU_EMAIL_FAVOURITES = 8

        const val MENU_SEARCH_INDEX = 0
        const val MENU_FAVOURITES_INDEX = 1
        const val MENU_SETTINGS_INDEX = 2
        const val MENU_HELP_INDEX = 3
        const val MENU_RANDOM_INDEX = 4
        const val MENU_ALPHA_SORT_INDEX = 5
        const val MENU_DATE_SORT_INDEX = 6
        const val MENU_CLEAR_FAVOURITES_INDEX = 7
        const val MENU_EMAIL_FAVOURITES_INDEX = 8

        const val MENUGROUP_INFO = 0
        const val MENUGROUP_ACTIONS = 1

        const val CONTEXT_GOOGLE_DICTIONARY = 0
        const val CONTEXT_WIKITIONARY = 1
    }
}
